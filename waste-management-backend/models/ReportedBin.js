...
const ReportedBin = sequelize.define('ReportedBin', {
    ...
    assignedVehicleId: { // ✅ NEW: Foreign key for the assigned vehicle
        type: DataTypes.INTEGER,
        allowNull: true,
        references: {
            model: 'Vehicles', // This references the new Vehicle model
            key: 'id',
        },
    },
    assignedAt: { // ✅ NEW: Timestamp for when the vehicle was assigned
        type: DataTypes.DATE,
        allowNull: true,
    },
}, {
